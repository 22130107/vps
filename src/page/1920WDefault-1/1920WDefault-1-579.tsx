...
import imgInput from "./1c6c58bb1ccd67528d4128f35590543a007b7cfa.png";
import imgTableHeader from "./00dd4cfb56f3e5defc98e70a344bb73aff3c5011.png";
...
function Data() {
  return (
    <div className="absolute h-[27px] left-[166px] right-[2px] top-[2px]" data-name="Data">
      ...
      <Background2 />
      <Image1 />
      <div className="-translate-y-1/2 [word-break:break-word] absolute flex flex-col font-['Inter:Bold',sans-serif] font-bold h-[12px] justify-center leading-[0] not-italic right-[201.13px] text-[#353535] text-[10.1px] text-right top-[52px] w-[161.04px]">
