...
import imgBackground from "./c98cac6c2da8ce198c535b02f7dcc15dd56bcf7b.png";
import imgLinkServiceTimePng from "./994cc6385b62912e7c1ede1e2d55c4516f59f529.png";
import imgBackground1 from "./9944a3ac640bfa6b12bd34a194cc24108c7c211d.png";
import imgDataMarketImgIndex from "./4518d13d6713557ae18cc8faded29dad03f9b740.png";
import imgGreenBulletPng from "./eb6612a4447bea64cb0136f4512e00e891699a4d.png";
import imgRedBulletPng from "./1c213a0db5472f5a6773e5a7883f9f1da015bf8e.png";
...
import imgLink2 from "./f3b624e77e219c35ecdeece92759747125c0dad1.png";
import imgIconSellALot from "./707a0f4298ea922d0baf4b89db9105756de15763.png";
import { imgGroup, imgGroup1 } from "./svg-ng1yz";
...
function List2() {
  return (
    <div className="[word-break:break-word] absolute font-['Inter:Bold',sans-serif] font-bold h-[34px] leading-[0] left-0 not-italic text-white top-0 w-[804.89px]" data-name="List">
      <div className="-translate-y-1/2 absolute flex flex-col h-[14px] justify-center left-[17px] text-[11.8px] top-[17px] w-[145.58px]">
        <p className="leading-[10px]">Quản lý danh mục tài sản</p>
      </div>
      <div className="-translate-y-1/2 absolute flex flex-col h-[14px] justify-center left-[196.38px] text-[11.8px] top-[17px] w-[96.22px]">
        <p className="leading-[10px]">Dịch vụ tài chính</p>
      </div>
      <div className="-translate-y-1/2 absolute flex flex-col h-[14px] justify-center left-[326.39px] text-[12px] top-[17px] w-[71.58px]">
        <p className="leading-[10px]">Lịch sử lệnh</p>
      </div>
      <div className="-translate-y-1/2 absolute flex flex-col h-[14px] justify-center left-[431.77px] text-[11.8px] top-[17px] w-[63.56px]">
...
function Input1() {
  return (
    <div className="absolute bg-[#7f7f7f] h-[20px] left-[178.02px] overflow-clip rounded-[10px] top-[39px] w-[40px]" data-name="Input">
      <div className="-translate-x-1/2 -translate-y-1/2 [word-break:break-word] absolute flex flex-col font-['Inter:Bold',sans-serif] font-bold h-[12px] justify-center leading-[0] left-[calc(50%+0.1px)] not-italic text-[10.5px] text-center text-white top-[10px] w-[23.45px]">
...
function Link4() {
  return (
    <div className="absolute h-[14px] left-[1068.31px] right-[20px] top-[15px]" data-name="Link">
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <img alt="" className="absolute h-[14285.71%] left-0 max-w-none top-[-9285.71%] w-[50.26%]" src={imgImage} />
      </div>
      <div className="-translate-x-1/2 -translate-y-1/2 [word-break:break-word] absolute flex flex-col font-['Inter:Bold',sans-serif] font-bold h-[14px] justify-center leading-[0] left-[calc(50%+7.6px)] not-italic text-[#64b600] text-[11.8px] text-center top-[7px] w-[44.89px]">
        <p className="leading-[normal]">Refresh</p>
      </div>
    </div>
  );
}
...
function Tab() {
  return (
    <div className="absolute border-[#d3d3d3] border-l border-r border-solid border-t h-[28.59px] left-[2.39px] top-[3.39px] w-[94.34px]" data-name="Tab">
      <div className="-translate-y-1/2 [word-break:break-word] absolute flex flex-col font-['Inter:Bold',sans-serif] font-bold h-[15px] justify-center leading-[0] left-[12px] not-italic text-[#232323] text-[12px] top-[13.5px] w-[68.54px]">
        <p className="leading-[15.6px]">Số dư tiền</p>
      </div>
    </div>
  );
}
...
function Tab1() {
  return (
    <div className="absolute bg-[#aca8a8] border-[#aaa] border-l border-r border-solid border-t h-[29.59px] left-[97.92px] top-[3.39px] w-[155.22px]" data-name="Tab">
      <div className="-translate-y-1/2 [word-break:break-word] absolute flex flex-col font-['Inter:Bold',sans-serif] font-bold h-[15px] justify-center leading-[0] left-[12px] not-italic text-[12px] text-white top-[13.5px] w-[129.42px]">
        <p className="leading-[15.6px]">Số dư chứng khoán</p>
      </div>
    </div>
  );
}
...
function Tablist() {
  return (
    <div className="absolute h-[31.98px] left-[12.39px] right-[12.39px] top-[63.39px]" data-name="Tablist">
      <Tab />
      <Tab1 />
    </div>
  );
...
function IconSellALot() {
  return (
    <div className="-translate-x-1/2 absolute left-[calc(50%-52.25px)] size-[16px] top-[11.44px]" data-name="icon-sell-a-lot">
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <img alt="" className="absolute left-0 max-w-none size-full top-0" src={imgIconSellALot} />
      </div>
    </div>
  );
}
...
function Background6() {
  return (
    <div className="absolute bg-[#777] h-[36px] left-[951.5px] right-[10px] rounded-[50px] top-[56.19px]" data-name="Background">
      <IconSellALot />
      <div className="-translate-x-1/2 -translate-y-1/2 [word-break:break-word] absolute flex flex-col font-['Inter:Bold',sans-serif] font-bold h-[16px] justify-center leading-[0] left-[calc(50%+10.33px)] not-italic text-[13px] text-center text-white top-[18px] w-[100.25px]">
        <p className="leading-[20px]">Bán nhiều mã</p>
      </div>
    </div>
  );
}
...
function Input2() {
  return <div className="absolute bg-white border border-[#b1b1b1] border-solid h-[29px] left-[909.69px] right-0 rounded-[10px] top-0" data-name="Input" />;
}

function Cell() {
  return (
    <div className="absolute border border-[#b7babc] border-solid h-[40px] left-0 right-[1065.86px] top-0" data-name="Cell">
      <div className="-translate-y-1/2 [word-break:break-word] absolute flex flex-col font-['Inter',sans-serif] font-extrabold h-[15px] justify-center leading-[0] left-0 right-0 not-italic text-[#222] text-[11.2px] text-center top-[19px]">
        <p className="leading-[normal]">STT</p>
      </div>
    </div>
  );
}
...
function Cell1() {
  return (
    <div className="absolute border border-[#b7babc] border-solid h-[40px] left-[27.3px] right-[1023.31px] top-0" data-name="Cell">
      <div className="-translate-y-1/2 [word-break:break-word] absolute flex flex-col font-['Inter',sans-serif] font-extrabold h-[15px] justify-center leading-[0] left-0 right-0 not-italic text-[#222] text-[11.8px] text-center top-[19px]">
        <p className="leading-[normal]">Mã CK</p>
      </div>
    </div>
  );
}
...
function Cell2() {
  return (
    <div className="absolute border border-[#b7babc] border-solid h-[40px] left-[69.84px] right-[988.43px] top-0" data-name="Cell">
      <div className="-translate-y-1/2 [word-break:break-word] absolute flex flex-col font-['Inter',sans-serif] font-extrabold h-[15px] justify-center leading-[0] left-0 right-0 not-italic text-[#222] text-[11.8px] text-center top-[19px]">
        <p className="leading-[normal]">Tổng</p>
      </div>
    </div>
  );
}
...
function Cell3() {
  return (
    <div className="absolute border border-[#b7babc] border-solid h-[40px] left-[104.74px] right-[919.39px] top-0" data-name="Cell">
      <div className="-translate-y-1/2 [word-break:break-word] absolute flex flex-col font-['Inter',sans-serif] font-extrabold h-[15px] justify-center leading-[0] left-0 right-0 not-italic text-[#222] text-[11.8px] text-center top-[19px]">
        <p className="leading-[normal]">Có thể bán</p>
      </div>
    </div>
  );
}
...
function Cell4() {
  return (
    <div className="absolute border border-[#b7babc] border-solid h-[40px] left-[173.77px] right-[899.03px] top-0" data-name="Cell">
      <div className="-translate-y-1/2 [word-break:break-word] absolute flex flex-col font-['Inter',sans-serif] font-extrabold h-[28px] justify-center leading-[1.2] left-0 right-0 not-italic text-[#222] text-[11.2px] text-center top-[19px]">
        <p className="leading-[normal] mb-0">KL</p>
        <p className="leading-[normal]">FS</p>
      </div>
    </div>
  );
}
...
function Cell5() {
  return (
    <div className="absolute border border-[#b7babc] border-solid h-[40px] left-[194.13px] right-[808.72px] top-0" data-name="Cell">
      <div className="-translate-y-1/2 [word-break:break-word] absolute flex flex-col font-['Inter',sans-serif] font-extrabold h-[28px] justify-center leading-[1.2] left-0 right-0 not-italic text-[#222] text-[11.2px] text-center top-[19px]">
        <p className="leading-[normal] mb-0">CP</p>
        <p className="leading-[normal]">Cổ tức thưởng</p>
      </div>
    </div>
  );
}
...
function Cell6() {
  return (
    <div className="absolute border border-[#b7babc] border-solid h-[40px] left-[284.44px] right-[748.14px] top-0" data-name="Cell">
      <div className="-translate-y-1/2 [word-break:break-word] absolute flex flex-col font-['Inter',sans-serif] font-extrabold h-[28px] justify-center leading-[1.2] left-0 right-0 not-italic text-[#222] text-[11.2px] text-center top-[19px]">
        <p className="leading-[normal] mb-0">Không</p>
        <p className="leading-[normal]">khả dụng</p>
      </div>
    </div>
  );
}
...
function Cell7() {
  return (
    <div className="absolute border border-[#b7babc] border-solid h-[40px] left-[345.02px] right-[702.92px] top-0" data-name="Cell">
      <div className="-translate-y-1/2 [word-break:break-word] absolute flex flex-col font-['Inter',sans-serif] font-extrabold h-[28px] justify-center leading-[1.2] left-0 right-0 not-italic text-[#222] text-[11.2px] text-center top-[19px]">
        <p className="leading-[normal] mb-0">Hưởng</p>
        <p className="leading-[normal]">quyền</p>
      </div>
    </div>
  );
}
...
function Cell8() {
  return (
    <div className="absolute border border-[#b7babc] border-solid h-[40px] left-[390.24px] right-[643.39px] top-0" data-name="Cell">
      <div className="-translate-y-1/2 [word-break:break-word] absolute flex flex-col font-['Inter',sans-serif] font-extrabold h-[28px] justify-center leading-[1.2] left-0 right-0 not-italic text-[#222] text-[11.2px] text-center top-[19px]">
        <p className="leading-[normal] mb-0">CK bán</p>
        <p className="leading-[normal]">chờ khớp</p>
      </div>
    </div>
  );
}
...
function Cell9() {
  return (
    <div className="absolute border border-[#b7babc] border-solid h-[20px] left-[449.77px] right-[545.53px] top-0" data-name="Cell">
      <div className="-translate-y-1/2 [word-break:break-word] absolute flex flex-col font-['Inter',sans-serif] font-extrabold h-[15px] justify-center leading-[0] left-0 right-0 not-italic text-[#222] text-[11.2px] text-center top-[9px]">
        <p className="leading-[normal]">T2</p>
      </div>
    </div>
  );
}
...
function Cell10() {
  return (
    <div className="absolute border border-[#b7babc] border-solid h-[20px] left-[547.63px] right-[447.67px] top-0" data-name="Cell">
      <div className="-translate-y-1/2 [word-break:break-word] absolute flex flex-col font-['Inter',sans-serif] font-extrabold h-[15px] justify-center leading-[0] left-0 right-0 not-italic text-[#222] text-[11.2px] text-center top-[9px]">
        <p className="leading-[normal]">T1</p>
      </div>
    </div>
  );
}
...
function Cell11() {
  return (
    <div className="absolute border border-[#b7babc] border-solid h-[20px] left-[645.49px] right-[349.81px] top-0" data-name="Cell">
      <div className="-translate-y-1/2 [word-break:break-word] absolute flex flex-col font-['Inter',sans-serif] font-extrabold h-[15px] justify-center leading-[0] left-0 right-0 not-italic text-[#222] text-[11.2px] text-center top-[9px]">
        <p className="leading-[normal]">T0</p>
      </div>
    </div>
  );
}
...
function Cell12() {
  return (
    <div className="absolute border border-[#b7babc] border-solid h-[40px] left-[743.34px] right-[306.23px] top-0" data-name="Cell">
      <div className="-translate-y-1/2 [word-break:break-word] absolute flex flex-col font-['Inter',sans-serif] font-extrabold h-[15px] justify-center leading-[0] left-0 right-0 not-italic text-[#222] text-[11.8px] text-center top-[19px]">
        <p className="leading-[normal]">Giá TB</p>
      </div>
    </div>
  );
}
...
function Cell13() {
  return (
    <div className="absolute border border-[#b7babc] border-solid h-[40px] left-[786.94px] right-[264.38px] top-0" data-name="Cell">
      <div className="-translate-y-1/2 [word-break:break-word] absolute flex flex-col font-['Inter',sans-serif] font-extrabold h-[15px] justify-center leading-[0] left-0 right-0 not-italic text-[#222] text-[11.8px] text-center top-[19px]">
        <p className="leading-[normal]">Giá trị</p>
      </div>
    </div>
  );
}
...
function Cell14() {
  return (
    <div className="absolute border border-[#b7babc] border-solid h-[40px] left-[828.78px] right-[221.66px] top-0" data-name="Cell">
      <div className="-translate-y-1/2 [word-break:break-word] absolute flex flex-col font-['Inter',sans-serif] font-extrabold h-[15px] justify-center leading-[0] left-0 right-0 not-italic text-[#222] text-[11.8px] text-center top-[19px]">
        <p className="leading-[normal]">Giá TT</p>
      </div>
    </div>
  );
}
...
function Cell15() {
  return (
    <div className="absolute border border-[#b7babc] border-solid h-[40px] left-[871.5px] right-[161.88px] top-0" data-name="Cell">
      <div className="-translate-y-1/2 [word-break:break-word] absolute flex flex-col font-['Inter',sans-serif] font-extrabold h-[15px] justify-center leading-[0] left-0 right-0 not-italic text-[#222] text-[11.8px] text-center top-[19px]">
        <p className="leading-[normal]">Giá trị TT</p>
      </div>
    </div>
  );
}
...
function Cell16() {
  return (
    <div className="absolute border border-[#b7babc] border-solid h-[40px] left-[931.28px] right-[113.6px] top-0" data-name="Cell">
      <div className="-translate-y-1/2 [word-break:break-word] absolute flex flex-col font-['Inter',sans-serif] font-extrabold h-[28px] justify-center leading-[1.2] left-0 right-0 not-italic text-[#222] text-[11.2px] text-center top-[19px]">
        <p className="leading-[normal] mb-0">Lãi/Lỗ</p>
        <p className="leading-[normal]">dự tính</p>
      </div>
    </div>
  );
}
...
function Cell17() {
  return (
    <div className="absolute border border-[#b7babc] border-solid h-[40px] left-[979.56px] right-[59.02px] top-0" data-name="Cell">
      <div className="-translate-y-1/2 [word-break:break-word] absolute flex flex-col font-['Inter',sans-serif] font-extrabold h-[28px] justify-center leading-[1.2] left-0 right-0 not-italic text-[#222] text-[11.2px] text-center top-[19px]">
        <p className="leading-[normal] mb-0">%lãi/Lỗ</p>
        <p className="leading-[normal]">dự tính</p>
      </div>
...
function Cell18() {
  return (
    <div className="absolute border border-[#b7babc] border-solid h-[40px] left-[1034.14px] right-0 top-0" data-name="Cell">
      <div className="-translate-y-1/2 [word-break:break-word] absolute flex flex-col font-['Inter',sans-serif] font-extrabold h-[15px] justify-center leading-[0] left-0 right-0 not-italic text-[#222] text-[11.8px] text-center top-[19px]">
        <p className="leading-[normal]">Đặt Lệnh</p>
      </div>
    </div>
  );
}
...
function Cell19() {
  return (
    <div className="absolute border border-[#b7babc] border-solid h-[20px] left-[449.77px] right-[592.56px] top-0" data-name="Cell">
      <div className="-translate-y-1/2 [word-break:break-word] absolute flex flex-col font-['Inter',sans-serif] font-extrabold h-[15px] justify-center leading-[0] left-0 right-0 not-italic text-[#222] text-[11.2px] text-center top-[9px]">
        <p className="leading-[normal]">CK mua</p>
      </div>
    </div>
  );
}
...
function Cell20() {
  return (
    <div className="absolute border border-[#b7babc] border-solid h-[20px] left-[500.59px] right-[545.54px] top-0" data-name="Cell">
      <div className="-translate-y-1/2 [word-break:break-word] absolute flex flex-col font-['Inter',sans-serif] font-extrabold h-[15px] justify-center leading-[0] left-0 right-0 not-italic text-[#222] text-[11.2px] text-center top-[9px]">
        <p className="leading-[normal]">CK bán</p>
      </div>
    </div>
  );
}
...
function Cell21() {
  return (
    <div className="absolute border border-[#b7babc] border-solid h-[20px] left-[547.63px] right-[494.7px] top-0" data-name="Cell">
      <div className="-translate-y-1/2 [word-break:break-word] absolute flex flex-col font-['Inter',sans-serif] font-extrabold h-[15px] justify-center leading-[0] left-0 right-0 not-italic text-[#222] text-[11.2px] text-center top-[9px]">
        <p className="leading-[normal]">CK mua</p>
      </div>
    </div>
...
function Cell22() {
  return (
    <div className="absolute border border-[#b7babc] border-solid h-[20px] left-[598.45px] right-[447.68px] top-0" data-name="Cell">
      <div className="-translate-y-1/2 [word-break:break-word] absolute flex flex-col font-['Inter',sans-serif] font-extrabold h-[15px] justify-center leading-[0] left-0 right-0 not-italic text-[#222] text-[11.2px] text-center top-[9px]">
        <p className="leading-[normal]">CK bán</p>
      </div>
    </div>
...
function Cell23() {
  return (
    <div className="absolute border border-[#b7babc] border-solid h-[20px] left-[645.49px] right-[396.84px] top-0" data-name="Cell">
      <div className="-translate-y-1/2 [word-break:break-word] absolute flex flex-col font-['Inter',sans-serif] font-extrabold h-[15px] justify-center leading-[0] left-0 right-0 not-italic text-[#222] text-[11.2px] text-center top-[9px]">
        <p className="leading-[normal]">CK mua</p>
      </div>
    </div>
...
function Cell24() {
  return (
    <div className="absolute border border-[#b7babc] border-solid h-[20px] left-[696.31px] right-[349.82px] top-0" data-name="Cell">
      <div className="-translate-y-1/2 [word-break:break-word] absolute flex flex-col font-['Inter',sans-serif] font-extrabold h-[15px] justify-center leading-[0] left-0 right-0 not-italic text-[#222] text-[11.2px] text-center top-[9px]">
        <p className="leading-[normal]">CK bán</p>
      </div>
    </div>
...
function Row4() {
  return (
    <div className="absolute h-[20px] left-0 right-0 top-[20px]" data-name="Row">
      <Cell19 />
      <Cell20 />
      <Cell21 />
      <Cell22 />
...
function TableHeader() {
  return (
    <div className="absolute h-[40px] left-[0.05%] right-[1.05%] top-[44.5px]" data-name="Table → Header">
      <div aria-hidden="true" className="absolute bg-gradient-to-b from-[#f2f8f8] via-[#e8f1f1] to-[#dee7e7] inset-0 pointer-events-none" />
      <Row3 />
      <Row4 />
    </div>
  );
...
function Link5() {
  return (
    <div className="absolute bg-white border border-[#8229e3] border-solid h-[15px] left-[967.74px] right-[119.04px] top-[90px]" data-name="Link">
...
function Link6() {
  return (
    <div className="absolute bg-white border border-[#8229e3] border-solid h-[15px] left-[1084.78px] right-[2px] top-[90px]" data-name="Link">
      <div className="-translate-x-1/2 -translate-y-1/2 [word-break:break-word] absolute flex flex-col font-['Inter:Bold',sans-serif] font-bold h-[12px] justify-center leading-[0] left-[calc(50%+0.1px)] not-italic text-[#8229e3] text-[11px] text-center top-[6px] w-[6.64px]">
        <p className="leading-[11px]">{`>`}</p>
      </div>
    </div>
...
function Tabpanel() {
  return (
    <div className="absolute h-[142px] left-[5px] right-[5px] top-[22px]" data-name="Tabpanel">
      <Background7 />
      <div className="-translate-y-1/2 [word-break:break-word] absolute flex flex-col font-['Inter:Bold',sans-serif] font-bold h-[15px] justify-center leading-[0] left-[789.24px] not-italic right-[205.33px] text-[#222] text-[12px] text-right top-[14.5px]">
        <p className="leading-[normal]">Mã chứng khoán</p>
      </div>
      <Input2 />
      <TableHeader />
      <Link5 />
      <div className="-translate-y-1/2 [word-break:break-word] absolute flex flex-col font-['Inter:Bold',sans-serif] font-bold h-[12px] justify-center leading-[0] left-[991.17px] not-italic right-[80.02px] text-[#8229e3] text-[11.5px] text-right top-[96px]">
        <p className="leading-[normal]">Trước</p>
      </div>
      <div className="-translate-y-1/2 [word-break:break-word] absolute flex flex-col font-['Inter:Bold',sans-serif] font-bold h-[12px] justify-center leading-[0] left-[1031px] not-italic right-[54.72px] text-[#232323] text-[11px] text-right top-[96px]">
        <p className="leading-[normal]">| 1 |</p>
      </div>
      <div className="-translate-y-1/2 [word-break:break-word] absolute flex flex-col font-['Inter:Bold',sans-serif] font-bold h-[12px] justify-center leading-[0] left-[1056.3px] not-italic right-[25.24px] text-[#8229e3] text-[10.8px] text-right top-[96px]">
...
function Container3() {
  return (
    <div className="absolute bottom-[-486.74px] right-[-0.01px] size-[0.01px]" data-name="Container">
      <Svg2 />
    </div>
  );
}
